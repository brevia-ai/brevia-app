  ...
  <main>
    <div class="space-y-12">
      <div class="flex justify-between items-start space-x-4">
        <div class="space-y-4">
          <h2 class="text-2xl md:text-3xl leading-tight font-bold">Test Chat</h2>
          <div class="text-neutral-600">Chat di test senza rag</div>
        </div>
      ...
      <div>
        <h2 class="relative text-lg md:text-xl leading-tight font-bold mb-6 border-b-2" @click="showHideConfig()">
