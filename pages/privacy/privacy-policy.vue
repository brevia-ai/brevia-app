<template>
    <header class="border-b border-dotted border-slate-700 pb-5">
        <h1 class="text-2xl text-slate-700">
            Privacy Policy di
            <span class="font-bold">playground.brevia.app</span>
        </h1>
        <h2 class="text-xs text-slate-400 mt-2">
            Questa Applicazione raccoglie alcuni Dati Personali dei propri
            Utenti.
        </h2>
    </header>
    <div v-if="!showCompletePP">
        <div class="mt-4 border-b border-dotted border-slate-700 pb-5">
            ...
            <div class="grid grid-cols-2 mt-4">
                <div class="flex flex-row">
                    <div>
                        <Icon
                            name="ph:file-fill"
                            class="text-3xl mr-3 text-slate-600"
                        />
                    </div>
                    <div class="text-sm flex flex-col space-y-2">
                        <p class="font-bold">
                            Registrazione ed autenticazione fornite direttamente
                            da questa Applicazione
                        </p>
                        <div>
                            <p class="font-bold">Registrazione diretta</p>
                            <p>
                                Dati Personali: cognome; email; nome; settore di
                                attività
                            </p>
                        </div>
                    </div>
                ...
                <div class="flex flex-row">
                    ...
                    <div class="text-sm flex flex-col space-y-2">
                        ...
                        <div>
                            <p class="font-bold">
                                Trasferimento di Dati verso paesi che
                                garantiscono standard europei e Trasferimento
                                verso paesi terzi sulla base di clausole
                                contrattuali tipo
                            </p>
        ...
        <div class="mt-4 border-b border-dotted border-slate-700 pb-5">
            <p class="font-bold text-slate-700">Informazioni di contatto</p>
            <div class="grid grid-cols-2 mt-4">
                <div class="flex flex-row">
                    <div>
                        <Icon
                            name="ph:user-list"
                            class="text-slate-600 text-3xl mr-3"
                        />
                    </div>
                    <div class="text-sm flex flex-col space-y-2">
                        <p class="font-bold">
                        ...
                        <p>
                            <span class="font-bold"
                                >Indirizzo email del Titolare:</span
                            >
    ...
    <div v-else>
        <div class="mt-4 border-b border-dotted border-slate-700 pb-5 text-sm">
            <h1 class="font-bold text-lg">Titolare del Trattamento dei Dati</h1>
            <p>Atlas Srl, viale XXI Aprile 61, 00162 – Roma (RM)</p>
            <p>
                <span class="font-bold">Indirizzo email del Titolare:</span
                >info@atlasconsulting.it
            </p>
        </div>
        <div class="mt-4 border-b border-dotted border-slate-700 pb-5 text-sm">
            <h1 class="font-bold text-lg">Tipologie di Dati raccolti</h1>
            <p>
                Fra i Dati Personali raccolti da questa Applicazione, in modo
                autonomo o tramite terze parti, ci sono: nome; cognome; email;
                settore di attività; varie tipologie di Dati.
            </p>
            <br />
            <p>
            ...
            <p>
                ...
                dei servizi terzi utilizzati da questa Applicazione ha la
                finalità di fornire il Servizio richiesto dall'Utente, oltre
                alle ulteriori finalità descritte nel presente documento e nella
                Cookie Policy.
            </p>
            <br />
            <p>
        ...
        <div
            class="mt-4 border-b border-dotted border-slate-700 pb-5 text-sm flex flex-col space-y-4"
        >
            <h1 class="font-bold text-lg">
                Modalità e luogo del trattamento dei Dati raccolti
            </h1>
            <div>
                <h3 class="font-bold">Modalità di trattamento</h3>
                <p>
                ...
                <p>
                    ...
                    Dati altri soggetti coinvolti nell’organizzazione di questa
            ...
            <div>
                ...
                <p>
                    I Dati Personali dell’Utente potrebbero essere trasferiti in
            ...
            <div>
                <h3 class="font-bold">Periodo di conservazione</h3>
                <p>
                    Se non diversamente indicato in questo documento, i Dati
                    Personali sono trattati e conservati per il tempo richiesto
                    dalla finalità per la quale sono stati raccolti e potrebbero
                    essere conservati per un periodo più lungo a causa di
                    eventuali obbligazioni legali o sulla base del consenso
                    degli Utenti.
                </p>
            </div>
        </div>
        ...
        >
            ...
            <p>
                ...
                le seguenti finalità: Registrazione ed autenticazione fornite
                direttamente da questa Applicazione e Trasferimento di Dati al
                di fuori della UE.
            </p>
            <p>
                Per ottenere informazioni dettagliate sulle finalità del
                trattamento e sui Dati Personali trattati per ciascuna finalità,
                l’Utente può fare riferimento alla sezione “Dettagli sul
        ...
        >
            ...
            <div class="border-slate-900 border flex flex-col space-y-4">
                ...
                >
                    <Icon name="ph:file-fill" class="text-3xl" />
                    <span class="font-bold mr-4"
                        >Registrazione ed autenticazione fornite direttamente da
                        questa Applicazione</span
                    >
                    <Icon
                        :name="
                            !showRegistration ? 'ph:caret-down' : 'ph:caret-up'
                        "
                    />
                </div>
                <transition name="grow-shrink">
                    <div v-if="showRegistration" class="mx-2 pb-4 space-y-4">
                        <p>
                            Con la registrazione o l’autenticazione l’Utente
                            consente a questa Applicazione di identificarlo e di
                            dargli accesso a servizi dedicati. I Dati Personali
                            sono raccolti e conservati esclusivamente a scopo di
                            registrazione o di identificazione. I Dati raccolti
                            sono solo quelli necessari a fornire il servizio
                            richiesto dall’Utente.
                        </p>
                        <p>Registrazione diretta (questa Applicazione)</p>
                        <p class="font-bold">
        ...
        >
            ...
            <div>
                <h3 class="font-bold">Base giuridica del trattamento</h3>
                <p class="mb-3">
            ...
            <div>
                ...
                <p>
                    ...
                    saranno cancellati. Pertanto, allo spirare di tale termine
                    il diritto di accesso, cancellazione, rettificazione ed il
                    diritto alla portabilità dei Dati non potranno più essere
                    esercitati.
                </p>
            </div>
            <div>
                <h3 class="font-bold">Diritti dell’Utente</h3>
                <p class="mb-6">
                    Gli Utenti possono esercitare determinati diritti con
                    riferimento ai Dati trattati dal Titolare.
                </p>
                <p class="mb-3">
                    In particolare, nei limiti previsti dalla legge, l’Utente ha
                    il diritto di:
                </p>
                <ul class="mb-3 list-disc ml-8">
                    <li>
                    ...
                    <li>
                        ...
                        quando esso avviene in virtù di una base giuridica
                    ...
                    <li>
                        <strong
                            >verificare e chiedere la rettificazione.</strong
                        >
                    ...
                    <li>
                        <strong
                            >ottenere la limitazione del trattamento.</strong
                        >
                    ...
                    <li>
                        ...
                        >
                        L’Utente può richiedere la cancellazione dei propri Dati
                    ...
                    <li>
                        ...
                        automatico e, ove tecnicamente fattibile, di ottenerne
                        il trasferimento senza ostacoli ad un altro titolare.
                    </li>
                    <li>
                        <strong>proporre reclamo.</strong> L’Utente può proporre
                        un reclamo all’autorità di controllo della protezione
                        dei dati personali competente o agire in sede
                        giudiziale.
                    </li>
                </ul>
                <p>
                    Gli Utenti hanno diritto di ottenere informazioni in merito
                    alla base giuridica per il trasferimento di Dati all'estero
                    incluso verso qualsiasi organizzazione internazionale
                    regolata dal diritto internazionale o costituita da due o
                    più paesi, come ad esempio l’ONU, nonché in merito alle
                    misure di sicurezza adottate dal Titolare per proteggere i
                    loro Dati.
                </p>
            </div>
            <div class="font-bold">
                <h3 class="mb-3">Dettagli sul diritto di opposizione</h3>
                <p class="mb-3">
                ...
                <p>
                    ...
                    al trattamento in qualsiasi momento, gratuitamente e senza
                    fornire alcuna motivazione. Qualora gli Utenti si oppongano
                    al trattamento per finalità di marketing diretto, i Dati
                    Personali non sono più oggetto di trattamento per tali
                    finalità. Per scoprire se il Titolare tratti Dati con
                    finalità di marketing diretto gli Utenti possono fare
                    riferimento alle rispettive sezioni di questo documento.
                </p>
            </div>
            <div>
                <h3 class="mb-3 font-bold">Come esercitare i diritti</h3>
                <p>
                    Per esercitare i propri diritti, gli Utenti possono
                    indirizzare una richiesta ai recapiti del Titolare indicati
                    in questo documento. La richiesta può essere depositate
                    gratuitamente e il Titolare risponderà nel più breve tempo
                    possibile, in ogni caso entro un mese, fornendo all’Utente
                    tutte le informazioni previste dalla legge. Eventuali
                    rettifiche, cancellazioni o limitazioni del trattamento
                    saranno comunicate dal Titolare a ciascuno dei destinatari,
                    se esistenti, a cui sono stati trasmessi i Dati Personali,
                    salvo che ciò si riveli impossibile o implichi uno sforzo
                    sproporzionato. Il Titolare comunica all'Utente tali
                    destinatari qualora egli lo richieda.
                </p>
            </div>
            <div>
                <h3 class="mb-3 font-bold">
                    Trasferimento di dati personali al di fuori dell'Unione
                    Europea
                </h3>
                <h3 class="mb-3 font-bold">
                    Trasferimento di Dati verso paesi che garantiscono standard
                    europei
                </h3>
                <p class="mb-3">
                    Quando questa è la base giuridica, il trasferimento di Dati
                    Personali dalla UE in paesi terzi avviene in base ad una
                    decisione d’adeguatezza adottata dalla Commissione Europea.
                    La Commissione Europea adotta decisioni di adeguatezza con
                    riferimento a singoli paesi terzi che ritiene garantire un
                    livello di protezione dei Dati Personali paragonabile a
                    quello previsto dalla legislazione Europea in materia di
                    protezione di Dati Personali. L’Utente può visionare la
                    lista aggiornata delle decisioni di adeguatezza sul sito
                    internet della Commissione Europea.
                </p>
                <h3 class="mb-3 font-bold">
                    Trasferimento verso paesi terzi sulla base di clausole
                    contrattuali tipo
                </h3>
                <p>
                    Quando questa è la base giuridica, il trasferimento di Dati
                    Personali dalla UE verso paesi terzi avviene sulla base di
                    clausole tipo di protezione dei Dati Personali adottate
                    dalla Commissione Europea.
                </p>
                <p>
                    In tali casi i destinatari dei Dati hanno accettato di
                    trattare i Dati Personali in conformità con i livelli di
                    protezione previsti dalla normativa UE. Gli Utenti possono
                    richiedere ulteriori informazioni contattando il Titolare
                    agli estremi indicati nel presente documento.
                </p>
            </div>
        </div>
        <div
        ...
        >
            ...
            <div>
                <h3 class="font-bold">Difesa in giudizio</h3>
                <p>
            ...
            <div>
                <h3 class="font-bold">Informative specifiche</h3>
                <p>
            ...
            <div>
                <h3 class="font-bold">Log di sistema e manutenzione</h3>
                <p>
            ...
            <div>
                <h3 class="font-bold">Modifiche a questa privacy policy</h3>
                <p>
        ...
        <div class="border-slate-900 border flex flex-col space-y-4">
            ...
            <transition name="grow-shrink">
                <div v-if="showLegalRef" class="mx-2 pb-4 space-y-4 text-sm">
                    <h3 class="font-bold">Dati Personali (o Dati)</h3>
                    <p>
                    ...
                    <h3 class="font-bold">Dati di Utilizzo</h3>
                    <p>
                    ...
                    <h3 class="font-bold">Questa Applicazione</h3>
                    <p>
                    ...
                    <h3 class="font-bold">Unione Europea (o UE)</h3>
                    <p>
                    ...
                    <h3 class="pt-2 border-top border-dotted border-slate-700">
                        Riferimenti legali
                    </h3>
                    <p>
    ...
    <footer class="flex flex-row justify-between">
        <button
            ...
            @click="showCompletePP = !showCompletePP"
        >
            <span v-if="!showCompletePP">Visualizza </span>
            <span v-else>Nascondi </span>
            la Privacy Policy Completa
        </button>
        <NuxtLink
            class="text-sm text-slate-600"
            to="/privacy/privacy-policy-49496944.pdf"
            target="_blank"
...
const showCompletePP = ref(false);
